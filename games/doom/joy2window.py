#!/usr/bin/env python3
"""
Per-player joystick → xdotool window-targeted key injection for 2P Doom.

Reads /dev/input/jsN and sends keystrokes directly to a specific X11 window
ID via xdotool, bypassing SDL2's focus-based routing and giving complete
per-player input isolation (both axes AND buttons).
...
# Doom key bindings (X keysym names for xdotool)
BUTTON_KEYS = {
    1: "ctrl",           # A      → fire
